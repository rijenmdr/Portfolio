...
const Navbar = ({ }: Props) => {
    ...
    return (
        <motion.nav
            ...
            className="fixed z-10 top-0 left-0 right-0 overflow-y-auto"
        >
            <div className="wrapper flex justify-between items-center rounded-full py-6 mt-6 bg-primary text-white border border-black-900/opacity-10 ">
                <Link href={"/"}>
